...
(function($){
	...
	function createWidget(obj,type,id,o,w,h,share,tweetId){
		...
		switch (type) {
			...
			url = frl+'&num='+n+'&callback=?&q=' + encodeURIComponent(url);*/
			url ='https://www.googleapis.com/youtube/v3/search?key=AIzaSyCbSrMgXhG6gLE5HZKvbvIB7ixc49vqhjQ&channelId=UCs7pQMqqe3_rzyqy9H1xD6g&part=snippet,id&order=date&maxResults=20';
			console.log(url);
			getFeed(ti,type,url,data,o,id,share,tweetId);
			break;
			...
			if(cq.length > 1){
				url = 'https://www.googleapis.com/youtube/v3/search?part=snippet&key=' + o.api_key + '&pageToken=&maxResults=' + n + '&q=' + cq[1];
