...
(function($){
	...
	function createWidget(obj,type,id,o,w,h,share,tweetId){
		...
		switch (type) {
			...
			if(o.subscribe){
			c += '<iframe src="https://www.youtube.com/subscribe_widget?p='+o.id+'" class="youtube-subscribe" scrolling="no" frameBorder="0" height="72"></iframe>';
