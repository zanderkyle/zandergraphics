		...
		<tr class="row<?php echo $i % 2; ?> rsf-entry" id="rsf-log-<?php echo $item->id;?>">
			...
			<td width="1%" nowrap="nowrap" class="rsf-status"><?php 
				if (!is_null($item->type)) {
					...
					echo '<button type="button" onclick="RSFirewall.Status.Change('.$item->id.',null, \'blockajax\', this)" class="btn btn-danger btn-small">'.JText::_('COM_RSFIREWALL_BLOCK').'</button>';
				}
			?></td>
