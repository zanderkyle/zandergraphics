	...
	public static function getLinks() {
		...
		switch ($option) {
			case 'com_phocacommander':
				$links[]	= array('Phoca Commander site', 'http://www.phoca.cz/phocacommander');
				$links[]	= array('Phoca Commander documentation site', 'http://www.phoca.cz/documentation');
				$links[]	= array('Phoca Commander download site', 'http://www.phoca.cz/download');
			break;
