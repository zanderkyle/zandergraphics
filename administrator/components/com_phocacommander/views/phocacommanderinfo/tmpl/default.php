...
echo '<div style="float:right;margin:10px;">'
	...
	.'<h3>'.JText::_('COM_PHOCACOMMANDER_PHOCA_COMMANDER').' - '. JText::_('COM_PHOCACOMMANDER_INFORMATION').'</h3>'
	.'<div style="clear:both;"></div>';

echo '<h3>'.  JText::_('COM_PHOCACOMMANDER_HELP').'</h3>';

echo '<p>'
.'<a href="http://www.phoca.cz/phocacommander/" target="_blank">Phoca Commander Main Site</a><br />'
.'<a href="http://www.phoca.cz/documentation/" target="_blank">Phoca Commander User Manual</a><br />'
.'<a href="http://www.phoca.cz/forum/" target="_blank">Phoca Commander Forum</a><br />'
.'</p>';
...
echo '<div style="border-top:1px solid #eee"></div><p>&nbsp;</p>' 
.'<div class="btn-group">
<a class="btn btn-large btn-primary" href="http://www.phoca.cz/version/index.php?phocacommander='.  $this->t['version'] .'" target="_blank"><i class="icon-loop icon-white"></i>&nbsp;&nbsp;'.  JText::_('COM_PHOCACOMMANDER_CHECK_FOR_UPDATE') .'</a></div>';
