...
<div class="row-fluid">
	...
	<div class="span10">
		<div id="filter-bar" class="btn-toolbar">
			...
			<?php } else { ?>
			<div class="btn-group pull-right">
				<?php echo JHtml::_('icon.filter', 'filter_level', $this->f_levels, JText::_('JOPTION_SELECT_MAX_LEVELS'), $this->state->get('filter.level'));?>
				<?php echo JHtml::_('icon.filter', 'filter_published', JHtml::_('jgrid.publishedOptions', $this->pconfig), JText::_('JOPTION_SELECT_PUBLISHED'), $this->state->get('filter.published'));?>
				<?php echo JHtml::_('icon.filter', 'filter_insitemap', $this->sitemap, JText::_('COM_RSSEO_SITEMAP_FILTER'), $this->state->get('filter.insitemap'));?>
			...
			<tbody>
				...
				<tr class="row<?php echo $i % 2; ?>">
					...
					<td class="nowrap small hidden-phone">
						...
						<a href="<?php echo JURI::root().$item->url; ?>" target="_blank">
