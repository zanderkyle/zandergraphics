...
class Password {
	...
	static $configs = array(
		'name' => array('value' => 'password{N}', 'label' => 'Field Name', 'type' => 'text'),
		'id' => array('value' => 'password{N}', 'label' => 'Field ID', 'type' => 'text'),
		'value' => array('value' => '', 'label' => 'Field Value', 'type' => 'text'),
		'label' => array('value' => 'Password Label', 'label' => 'Label', 'type' => 'text', 'class' => 'L'),
	...
	public static function config($data = array(), $k = '{N}'){
		echo \GCore\Helpers\Html::formSecStart('original_element_conifg', 'password_origin_config');
