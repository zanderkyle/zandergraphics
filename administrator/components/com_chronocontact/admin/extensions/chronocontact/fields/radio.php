...
class Radio {
	...
	static $configs = array(
		'name' => array('value' => 'radio{N}', 'label' => 'Field Name', 'type' => 'text'),
		'id' => array('value' => 'radio{N}', 'label' => 'Field ID', 'type' => 'text'),
		'options' => array('value' => "0=No\n1=Yes", 'label' => 'Options', 'type' => 'textarea', 'alt' => 'options', 'class' => 'L', 'sublabel' => 'In Multiline format, value=Title'),
		'value' => array('value' => '', 'label' => 'Checked Value', 'type' => 'text'),
		'label' => array('value' => 'Radio Label', 'label' => 'Label', 'type' => 'text', 'class' => 'L'),
	...
	public static function config($data = array(), $k = '{N}'){
		echo \GCore\Helpers\Html::formSecStart('original_element_conifg', 'radio_origin_config');
