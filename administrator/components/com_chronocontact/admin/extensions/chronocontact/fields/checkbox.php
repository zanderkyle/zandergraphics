...
class Checkbox {
	...
	static $configs = array(
		'name' => array('value' => 'checkbox{N}', 'label' => 'Field Name', 'type' => 'text'),
		'id' => array('value' => 'checkbox{N}', 'label' => 'Field ID', 'type' => 'text'),
		'value' => array('value' => '', 'label' => 'Field Value', 'type' => 'text'),
		'label' => array('value' => 'Checkbox Label', 'label' => 'Label', 'type' => 'text', 'class' => 'L'),
	...
	public static function config($data = array(), $k = '{N}'){
		echo \GCore\Helpers\Html::formSecStart('original_element_conifg', 'checkbox_origin_config');
