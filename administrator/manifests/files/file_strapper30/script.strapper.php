<?php
/**
 * @package        Akeeba Strapper
 * @copyright      2012-2015 Nicholas K. Dionysopoulos / Akeeba Ltd
...
class file_strapper30InstallerScript
{
	...
	/**
	 * Is this package an update to the currently installed Strapper? If not (we're a downgrade) we will return false
	...
	protected function amIAnUpdate(JInstallerAdapterFile $parent)
	{
		...
		// If Strapper is not really installed (someone removed the directory instead of uninstalling?) I have to install it.
